#ifndef CARE_WarpcoreMinhasher_CUH
#define CARE_WarpcoreMinhasher_CUH
...
namespace warpcoreminhasher{
    ...
    class WarpcoreMinhasher{
    private:
        using CpuHashTable = CpuReadOnlyMultiValueHashTable<kmer_type, read_number>;
        using GpuHashTable = CpuReadOnlyMultiValueHashTable<kmer_type, read_number>;
    public:
        ...
        struct QueryHandle{
            ...
            void resize(const WarpcoreMinhasher& minhasher, std::size_t numSequences, int numThreads = 1){
        ...
        WarpcoreMinhasher() : WarpcoreMinhasher(16, 50){

        }

        WarpcoreMinhasher(int kmerSize, int resultsPerMapThreshold)
            : kmerSize(kmerSize), resultsPerMapThreshold(resultsPerMapThreshold){

        }

        WarpcoreMinhasher(const WarpcoreMinhasher&) = delete;
        WarpcoreMinhasher(WarpcoreMinhasher&&) = default;
        WarpcoreMinhasher& operator=(const WarpcoreMinhasher&) = delete;
        WarpcoreMinhasher& operator=(WarpcoreMinhasher&&) = default;
    ...
    private:
        ...
        std::vector<std::unique_ptr<GpuHashTable>> gpuHashTables;
    };
