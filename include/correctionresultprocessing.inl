...
#ifdef __NVCC__
    std::cerr << "constructOutputFileFromCorrectionResults __NVCC__\n";
#else 
    std::cerr << "constructOutputFileFromCorrectionResults no __NVCC__\n";
#endif
#ifdef __CUDA__
    std::cerr << "constructOutputFileFromCorrectionResults __CUDA__\n";
#else 
    std::cerr << "constructOutputFileFromCorrectionResults no __CUDA__\n";
#endif
