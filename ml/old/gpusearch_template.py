...
def main(prefixes, effiles, test_index):
    ...
    # process(anchor_map, RandomForestClassifier, {"n_jobs":NJOBS, "max_depth":22}, "_maxdepth_anchor.rf", test_index)
    # process(cands_map, RandomForestClassifier, {"n_jobs":NJOBS, "max_depth":22}, "_maxdepth_cands.rf", test_index)
