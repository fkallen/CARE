...
EVALDIR=/home/jcascitt/ec/leave_one_out
...
#
#$CARE -i $FILE6 -c $COV6 -o ${PREFIX6}_cc $FLAGS \
#	--candidateCorrection \
...
rm melan-30_pr melan-30_ht
grid_search $FILE5 $FILE5EF $COV5 $PREFIX5 5 75 75 5
#grid_search $FILE2 $FILE2EF $COV2 $PREFIX2 2 55 90 5
#grid_search $FILE3 $FILE3EF $COV3 $PREFIX3 3 55 90 5
#grid_search $FILE4 $FILE4EF $COV4 $PREFIX4 4 55 90 5
#grid_search $FILE5 $FILE5EF $COV5 $PREFIX5 5 55 90 5
#grid_search $FILE6 $FILE6EF $COV6 $PREFIX6 6 55 90 5
