...
namespace care{
    ...
    void ReadExtenderGpu::computeMSAs(BatchData& batchData, cudaStream_t firstStream, cudaStream_t secondStream) const{
    ...
    void ReadExtenderGpu::copyBuffersToHost(BatchData& batchData, cudaStream_t firstStream, cudaStream_t secondStream) const{
