...
SOURCES_CPU_AND_GPU = $(filter-out src/cpugpuproxy_cpu.cpp src/dispatch_care_cpu.cpp,$(SOURCES_CPU_AND_GPU_))
...
SOURCES_ONLY_CPU = src/cpugpuproxy_cpu.cpp src/dispatch_care_cpu.cpp
